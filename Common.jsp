...
//Database connection string
  ...
  // static final String DBDriver  ="com.caucho.jdbc.mysql.Driver";
  static final String DBDriver  ="org.gjt.mm.mysql.Driver";
  static final String strConn   ="jdbc:mysql://127.0.0.1/bookstoreDB";
  static final String DBusername="root";
  static final String DBpassword="masplas_test";

  public static String loadDriver () {
    String sErr = "";
    try {
	System.out.println(" Register Driver : " + DBDriver );
  ...
  java.sql.Connection cn() throws java.sql.SQLException {
      System.out.println("Manager's drivers: " + java.sql.DriverManager.getDrivers());
      java.util.Enumeration drivers = java.sql.DriverManager.getDrivers();
